...
from src.config import (
    ...
    # normalize_agent_litellm_model removed - agent system deleted
...
class SystemConfigService:
    ...
    def _reload_runtime_singletons() -> None:
        ...
        # Note: stock-related singletons (fetcher, search) removed.
    ...
    def _validate_llm_runtime_selection(effective_map: Dict[str, str]) -> List[Dict[str, Any]]:
        ...
        # AGENT_LITELLM_MODEL validation removed - agent system deleted
